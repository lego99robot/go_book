...
export function Header() {
  return (
    <header 
      className="fixed top-0 left-0 right-0 z-10 h-[var(--header-h)] flex items-center justify-between gap-4 px-[clamp(1rem,4vw,3.5rem)] border-b border-[rgba(23,21,18,0.08)] bg-[rgba(244,240,231,0.72)] backdrop-blur-[18px]"
      aria-label="Главная навигация"
    >
      <Link 
        href="#top" 
        className="flex items-center gap-3 font-bold tracking-normal min-w-max"
      ...
      >
        ...
        <span>Читательская полка</span>
      </Link>
      <nav className="flex items-center gap-[clamp(0.7rem,2.5vw,2rem)] text-[rgba(23,21,18,0.74)] text-sm font-semibold min-w-0" aria-label="Навигация по книгам">
